...
export const DEPARTMENTS: Department[] = [
  {
    ...
    courses: ["B.Com (General)", "B.Com (Computer Applications)", "M.Com", "Banking & Insurance Certificate"],
  ...
  },
  {
    ...
    courses: ["B.A. (History)", "B.A. (Political Science)", "B.A. (English)", "B.A. (Sociology)"],
  ...
  },
  {
    ...
    courses: ["B.Sc. (Botany)", "M.Sc. (Botany)", "Plant Tissue Culture Certificate"],
  ...
  },
  {
    ...
    courses: ["B.Sc. (Zoology)", "M.Sc. (Zoology)", "Wildlife Studies Certificate"],
  ...
  },
  {
    ...
    courses: ["B.Sc. (Chemistry)", "M.Sc. (Analytical Chemistry)", "Industrial Chemistry Diploma"],
