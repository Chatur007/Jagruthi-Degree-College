...
import { A as Check, E as ChevronUp, T as CircleCheck, k as ChevronDown, n as X } from "../_libs/lucide-react.mjs";
import { i as cn, t as Button } from "./SiteShell-CFEJpPYK.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/AdmissionDialog-Cb6gubI4.js
...
var schema = objectType({
	...
	gender: stringType().min(1, "Select gender"),
	dob: stringType().min(1, "Date of birth is required"),
	mobile: stringType().regex(/^[0-9]{10}$/, "Enter a valid 10-digit mobile"),
	email: stringType().trim().email("Enter a valid email").max(255),
	qualification: stringType().trim().min(2, "Required").max(100),
	percentage: stringType().regex(/^\d{1,3}(\.\d+)?$/, "Enter a valid percentage"),
	passingYear: stringType().regex(/^\d{4}$/, "Enter a valid year"),
	department: stringType().min(1, "Select a department"),
	course: stringType().trim().min(1, "Required").max(100),
	address: stringType().trim().min(3, "Required").max(200),
	city: stringType().trim().min(2, "Required").max(80),
	state: stringType().trim().min(2, "Required").max(80),
	pin: stringType().regex(/^\d{6}$/, "Enter a 6-digit PIN")
});
function AdmissionDialog({ trigger }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, {
			...
			children: submitted ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mx-auto h-16 w-16 text-[var(--gold)]" }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Thank you! Our admissions team will contact you within 2 working days."
					}),
			...
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Fill in your details. All fields are required." })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				onSubmit,
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								name: "department",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Select Department" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: DEPARTMENTS.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
									value: d.slug,
									children: d.short
								}, d.slug)) })]
							})
...
function Section({ title, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
		className: "mb-3 border-b pb-1 font-display text-lg font-semibold text-[var(--navy)] dark:text-[var(--gold)]",
		children: title
